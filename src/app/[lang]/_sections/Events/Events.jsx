    ...
    >
      ...
      >
        <div className=" pt-8 pb-36 sm:mx-8 max-w-6xl lg:mx-auto lg:pt-12 lg:pb-36 lg:px-16 bg-white bg-opacity-95 rounded-xl slider-events">
          ...
          <button className=" flex mb-1 text-xl absolute bottom-10 left-1/2 transform -translate-x-1/2 hover:text-tortuga-light text-tortuga-dark border-2 border-tortuga-dark hover:border-tortuga-light font-kalam py-1 px-8 sm:px-12 rounded transition-all duration-200 ease-in-out">
