...
const About = ({ fetchedData }) => {
  ...
  return (
    ...
    >
      <div
        className="mobile-bg-adjust flex justify-center relative max-h-svh bg-gray-300 mx-4 bg-opacity-0  text-slate-50 overflow-auto sm:bg-opacity-40 xl:mx-0 rounded-lg"
        id="about"
      >
